...
{
    public abstract class CountryStateApplicationWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CountryStateApplicationWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CountryStateApplicationWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CountryStateApplicationDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CountryStateApplicationDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CountryStateApplicationDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CountryStateApplicationDbContext, Task<T>> func)
        {
            T result;
