...
{
    public class CountryStateApplicationAuthorizationProvider : AuthorizationProvider
    {
        ...
        {
            return new LocalizableString(name, CountryStateApplicationConsts.LocalizationSourceName);
        }
    }
}
